...
/**
 * Tøída Gaussovského generátoru dat, generuje data do souboru "data_generated_gauss.txt".
 * @author Muhr - Pelikán
 */
public class DataGeneratorGauss {
    ...
    public static int generuj(int d, int s, int z, int t, int min, int max) throws IOException {
        ...
        if (min >= max || min < 0){
            ...
            System.out.println("Byl vygenerovan soubor data_generated_gauss.txt");
            return 0;
        }
    }
